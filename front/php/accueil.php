...
<html lang="fr">
  ...
  <div class="container d-flex justify-content-between align-items-center py-3 flex-wrap">
    ...
    <div class="d-flex align-items-center">
      ...
      <div>
        <p class="mb-0"><a href="https://www.linkedin.com/in/cl%C3%A9ment-robin123/">Clément Robin</a></p>
        <p class="mb-0">Louis Lacoste</p>
      </div>
    </div>
